...
users = [
  ...
  { first_name: 'Cristiano', last_name: 'Ronaldo', email: 'cr7@uplay.com', password: 'ronaldoronaldo', password_confirmation: 'useruser', confirmed_at: Time.now, role_id: Role.find_by_name('athlete').id },
  { first_name: 'Lionel', last_name: 'Messi', email: 'messi@uplay.com', password: 'messimessi', password_confirmation: 'useruser', confirmed_at: Time.now, role_id: Role.find_by_name('athlete').id }
]
