...
courses = [
  ...
  { abbreviation: 'CComunicacao' 'Ciências da Comunicação ' },
  ...
  { abbreviation: 'EBásica', name: 'Educação Básica' },
  { abbreviation: 'Enfermagem', name: 'Enfermagem' },
  { abbreviation: 'EBiológica', name: 'Engenharia Biológica (MI)' },
  ...
  { abbreviation: 'EFísica', name: 'Engenharia Física (MI)' },
  { abbreviation: 'EGIndustrial' 'Engenharia e Gestão Industrial (MI)' },
  { abbreviation: 'EGSInformação' 'Engenharia e Gestão de Sistemas de Informação (MI)' },
  { abbreviation: 'EInformática', name: 'Engenharia Informática' },
  { abbreviation: 'EMateriais', name: 'Engenharia de Materiais (MI)' },
  { abbreviation: 'EMecânica', name: 'Engenharia Mecânica (MI)' },
  { abbreviation: 'EPolímeros', name: 'Engenharia de Polímeros (MI)' },
  { abbreviation: 'ETêxtil', name: 'Engenharia Têxtil (MI)' },
  { abbreviation: 'EAplicada', name: 'Estatística Aplicada' },
  { abbreviation: 'ECulturais', name: 'Estudos Culturais' },
  { abbreviation: 'EPLusófonos' 'Estudos Portugueses e Lusófonos' },
  { abbreviation: 'Filosofia', name: 'Filosofia' },
  { abbreviation: 'Física', name: 'Física' },
  { abbreviation: 'GPlaneamento', name: 'Geografia e Planeamento' },
  { abbreviation: 'G', name: 'Geologia ' },
  { abbreviation: 'Gestão', name: 'Gestão' },
  { abbreviation: 'História', name: 'História' },
  { abbreviation: 'LAplicadas' 'Línguas Aplicadas ' },
  { abbreviation: 'LCOrientais' 'Línguas e Culturas Orientais' },
  { abbreviation: 'LLEuropeias' 'Línguas e Literaturas Europeias' },
  { abbreviation: 'Marketing', name: 'Marketing' },
  { abbreviation: 'Matemática', name: 'Matemática' },
  { abbreviation: 'Medicina', name: 'M(MI)' },
  { abbreviation: 'Música', name: 'Música' },
  ...
  { abbreviation: 'Química', name: 'Química' },
